/* Editable source of truth for the data exposed over MCP.
   Mirrors the public content rendered on the portfolio site. */

export const profile = {
  name: "Manan Gupta",
  headline: "Growth & Performance Marketing Leader",
  summary:
    "12+ years driving measurable growth through paid media, performance marketing and data-led strategy across hospitality, enterprise and agency.",
  markets: [
...
export const capabilities = [
  { name: "Paid Media & Acquisition", desc: "Google Ads · Meta Ads · LinkedIn Ads" },
  { name: "Demand Generation", desc: "Building qualified B2B pipeline" },
  { name: "Analytics & Measurement", desc: "GA4 · GTM · Conversion Tracking" },
  { name: "Media Investment Optimisation", desc: "Improving ROAS · CPL · Budget Efficiency" },
  { name: "Agency & Stakeholder Leadership", desc: "Strategy · Governance · Execution" },
];
